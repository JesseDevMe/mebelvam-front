    ...
    return (
        <>
            ...
            <form className="mt-[30px] flex flex-col items-center w-full max-w-[440px] mx-auto" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="py-[15px] bg-dark rounded max-w-[300px] w-full mt-[30px] text-light font-montserrat font-semibold cursor-pointer" value="Войти" type="submit"/>
            </form>
            <div
            ...
            <div className="mt-[50px] flex flex-row gap-x-3.5 mx-auto w-fit">
                <Link href="http://localhost:1337/api/connect/vk/" className="w-12 h-12 border-dark border rounded-full cursor-pointer flex justify-center items-center">
                ...
                <Link href="http://localhost:1337/api/connect/google/" className="w-12 h-12 border-dark border rounded-full cursor-pointer flex justify-center items-center">
