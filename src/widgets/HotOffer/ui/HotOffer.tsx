    ...
    return (
        <div className="max-w-[1520px] w-full mx-auto">
            ...
            >
                ...
                <button ref={navigationPrevRef} className="absolute top-1/2 left-5 -translate-y-1/2 hidden md:block z-[40]">
                ...
                <button ref={navigationNextRef} className="absolute top-1/2 right-5 -translate-y-1/2 hidden md:block z-[40]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="40" viewBox="0 0 42 40" fill="none">
