...
const AboutUs: FC<AboutUsProps> = ({}) => {
    ...
    return (
        <div id="aboutus" className="px-2.5 md:px-5 lg:px-10 xl:px-20 py-8 lg:py-12 bg-light md:grid md:grid-cols-[auto_auto] gap-x-5">
            <h2 className="text-xl lg:text-3xl font-montserrat font-semibold text-center leading-normal md:col-span-2">О нас</h2>
            <h3 className="text-base lg:text-xl mt-4 lg:mt-12 font-montserrat font-semibold text-center lg:text-start leading-normal md:col-span-2 lg:col-span-1">Интернет-магазин мебели в
            ...
            <div className="mt-5 flex flex-col items-center md:items-start gap-y-5 lg:col-start-2 lg:row-start-2 lg:row-span-3">
                <div className="ml-10 md:ml-0 lg:ml-11 overflow-hidden relative w-[188px] h-[305px] md:w-[150px] md:h-[240px] lg:w-[254px] lg:h-[410px]">
            ...
            <div className="col-span-2 lg:col-span-1 flex flex-wrap justify-center min-[1100px]:justify-between gap-5 mt-16 font-montserrat font-semibold md:font-roboto">
                <div
