    ...
    return (
        ...
        >
            ...
            <div className="order-2 sm:order-3 max-w-[400px]">
                ...
                <p className="mt-2.5">У нас большой склад, поэтому все основные позиции есть в наличии. Это позволяет нам быстро доставлять заказы по низким ценам.</p>
                <p><span className="font-bold block mt-2.5">Склад работает:</span> пн-пт—9:00 - 18:00, сб—10:00 - 16:00, вс—выходной</p>
            </div>
