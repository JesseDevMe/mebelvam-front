...
const FavoritesBtn: FC<FavoritesBtnProps> = ({ id }) => {
    ...
    return (
        <div onClick={toggleHandler} className="absolute top-0 right-0 z-[9] p-2.5 bg-[rgba(253,253,253,0.80)] rounded-bl group">
            <svg className="md:w-6 md:h-[22px] group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="17" height="15" viewBox="0 0 24 22" fill={`${isActive ? '#A50B34' : 'none'}`}>
