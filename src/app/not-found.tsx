    ...
    return (
        <div className="max-w-[1520px] w-full mx-auto px-2.5 md:px-5 lg:px-10 xl:px-20">
            <div className="relative w-full h-full min-h-[800px] pt-[162px] md:pt-[250px] md:min-h-[900px]">
                <Image className="absolute top-0 left-1/2 -translate-x-1/2 md:w-[500px] lg:left-5 lg:translate-x-0" width={340} height={120} src={sofa} alt=''/>
                <Image className="hidden lg:block absolute right-0 top-5" width={240} src={chairs_table} alt=''/>
                <Image className="hidden md:block absolute left-0 top-1/2 -translate-y-[10%]" height={450} src={tumba} alt=''/>
                ...
                <Image className="absolute bottom-0 left-1/2 -translate-x-1/2 lg:w-[320px]" width={260} src={lamps} alt=''/>
            </div>
